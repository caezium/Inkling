...
struct Hotkey: Codable, Hashable {
    ...
    var displayString: String {
        ...
        parts.append(KeyCodeMap.symbol(for: keyCode))
        return parts.joined()
    }
}
...
enum KeyCodeMap {
    static func symbol(for code: UInt32) -> String {
        ...
        case kVK_ANSI_Slash: return "/"; case kVK_ANSI_Semicolon: return ";"
        case kVK_ANSI_Quote: return "'"; case kVK_ANSI_LeftBracket: return "["
